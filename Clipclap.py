...
logo=(yellow+'''  _   _ _   _ ____  ____ ___ _   _
| \ | | | | |  _ \|  _ \_ _| \ | |
|  \| | | | | |_) | | | | ||  \| |
| |\  | |_| |  _ <| |_| | || |\  |
|_| \_|\___/|_| \_\____/___|_| \_|'''+green+'Pagejugan')
...
def bottie():
	...
	mengetik ('\033[1;92m Getting ches')
	print (50 * '\033[1;94m\xe2\x95\x90')
	for i in range(len(rewardtime)):
	  ...
	  status = page["msg"]
	  if int(code) == 4000:
	    mengetik ('\033[1;92m[-] \033[1;93m Already Get this chess')
	  else:
	    mengetik ('\033[1;93mGet \033[1;92m-> \033[1;95m{}'.format(rewardtype[i]))
	Openches()
def Openches():
  try:
    h=open('Token.txt')
    ...
    Data()
  print (50 * '\033[1;94m\xe2\x95\x90')
  mengetik ('\033[1;92m opening ches')
  print (50 * '\033[1;94m\xe2\x95\x90')
  ...
  try:
    ...
    if int(copper_count)==0:
      mengetik ('\033[1;94m No copper chess')
    for i in range(int(copper_count)):
      ...
      if message=='Success':
        for i in range(len(page_['data']['rewards'])):
          ...
          mengetik ('\033[1;93mCopper ches \033[1;92m-> \033[1;95m{} \033[1;91m/\033[1;93m {}'.format(ty,bilang))
      else:
        pass
  except:
    mengetik ('\033[1;94m No Copper chess')
  ...
  try:
    ...
    if int(silver_count)==0:
      mengetik ('\033[1;94m No silver chess')
    for i in range(int(silver_count)):
      ...
      if message=='Success':
        for i in range(len(page_['data']['rewards'])):
          ...
          ty=data['type']
          bilang=data['quantity']
          mengetik ('\033[1;92mSilver ches \033[1;92m-> \033[1;96m{} \033[1;91m/\033[1;93m {}'.format(ty,bilang))
      else:
        pass
  except:
    mengetik ('\033[1;94m No silver chess')
  ...
  try:
    ...
    gold_count=gold['num']
    if int(gold_count)==0:
      mengetik ('\033[1;94m No gold chess')
    for i in range(int(gold_count)):
      ...
      if message=='Success':
        for i in range(len(page_['data']['rewards'])):
          ...
          ty=data['type']
          bilang=data['quantity']
          mengetik ('\033[1;92mGold ches \033[1;92m-> \033[1;96m{} \033[1;91m/\033[1;93m {}'.format(ty,bilang))
      else:
        pass
  except:
    mengetik ('\033[1;94m No Gold chess')
  ...
  try:
    ...
    if int(newbie_count)==0:
      mengetik ('\033[1;94m No Newbie chess')
    for i in range(int(newbie_count)):
      ...
      if message=='Success':
        for i in range(len(page_['data']['rewards'])):
          ...
          ty=data['type']
          bilang=data['quantity']
          mengetik ('\033[1;92mNewbie ches \033[1;92m-> \033[1;96m{} \033[1;91m/\033[1;93m {}'.format(ty,bilang))
      else:
        pass
  except:
    mengetik ('\033[1;94m No Newbie chess')
  ...
  try:
    ...
    if int(diamond_count)==0:
      mengetik ('\033[1;94m No Diamond chess')
    for i in range(int(diamond_count)):
      ...
      if message=='Success':
        for i in range(len(page_['data']['rewards'])):
          ...
          ty=data['type']
          bilang=data['quantity']
          mengetik ('\033[1;92mDiamond ches \033[1;92m-> \033[1;96m{} \033[1;91m/\033[1;93m {}'.format(ty,bilang))
      else:
        pass
  except:
    mengetik ('\033[1;94m Tidak ada peti Diamond')
  mengetik ('\n\033[1;92m Peti sudah di buka semua')
  video()
def video():
  try:
    h=open('Token.txt')
    ...
    Data()
  print (50 * '\033[1;94m\xe2\x95\x90')
  mengetik ('\033[1;92m Video bonus')
  print (50 * '\033[1;94m\xe2\x95\x90')
  ...
  c=json.loads(b.text)
  if c['msg'] == 'Success':
    mengetik ('\033[1;92m Get-> \033[1;93mvideo Bonus 500\n')
  else:
    mengetik ('\033[1;94m Already Got')
  achivement()
def achivement():
  try:
    h=open('Token.txt')
    ...
    Data()
  print (50 * '\033[1;94m\xe2\x95\x90')
  mengetik ('\033[1;92m Checking Achievement')
  print (50 * '\033[1;94m\xe2\x95\x90')
  ...
  for i in range(3):
    ...
    try:
      if bool(page['ifSuccess'])==True or str(page['ifSuccess'])=="true":
        mengetik ('\033[1;92m=> \033[1;96mGot bonus \033[1;93m'+page_1[i]['progressBar']['rewardNum'])
      else:
        pass
    except:
      pass
...
def watching():
  ...
  try:
    ...
    mengetik ('\033[1;91m[\033[1;92mFile Missing\033[1;91m]')
    Data()
  print (50 * '\033[1;94m\xe2\x95\x90')
  mengetik ('\033[1;92m Watching Homefeed')
  print (50 * '\033[1;94m\xe2\x95\x90')
  ...
  try:
    ...
    mengetik ('\033[1;91mSomething rwong')
  for i in range(len(b)):
    ...
    if str(g)=='True':
      try:
        ...
        try:
          mengetik ('\033[1;92m_watch: \033[1;93m{}'.format(earn['authorName']))
        except:
          try:
            mengetik ('_watch: {}'.format(earn['sourceId'][0:6]))
          except:
            pass
      url=('https://cpv.cc.lerjin.com/behavior/event')
      header={'charset': 'UTF-8','timezone': '8','appver': '3.8.0','apiver': '42','sysver': '11','ostype': 'android','lang': 'en','userId': '{}'.format(str(uid)),'uuid': '{}'.format(str(uuid)),'Content-Type': 'application/json; charset=utf-8','Content-Length': '99','token': '{}'.format(str(token)),'Host': 'cpv.cc.lerjin.com','Connection': 'Keep-Alive','Accept-Encoding': 'gzip','User-Agent': 'okhttp/4.2.1'}
...
def choose():
  ...
  if pick == '':
      mengetik  ('\033[1;94m\xe2\x95\x91\033[1;91m[Type invalid]\033[1;92m')
      choose()
  elif pick == '1':
    bottie()
  elif pick == '2':
    ...
    mengetik  ('\033[1;92m\xe2\x95\x91\033[1;91m[Type invalid]  \033[1;92m')
    choose()
...
def Data():
  ...
  try:
    ...
    os.system('reset')
    mengetik  ('\033[1;94m' + 50 * '\xe2\x95\x90')
    mengetik  ('\033[1;94m\xe2\x95\x94\xe2\x95\x90' + 50 * '\xe2\x95\x90')
    mengetik  ('\033[1;94m\xe2\x95\x91-> \033[1;92mToken\033[1;91m:')
    code_1 = raw_input('\033[1;94m\xe2\x95\x9a\xe2\x95\x90\033[1;92m>>> \033[1;92m')
    save=open('Token.txt', 'w')
    save.write(code_1)
    save.close()
    mengetik  ('\033[1;94m\xe2\x95\x91-> \033[1;92muuid\033[1;91m:')
    code_2 = raw_input('\033[1;94m\xe2\x95\x9a\xe2\x95\x90\033[1;92m>>> \033[1;92m')
    save=open('uuid.txt', 'w')
    save.write(code_1)
    save.close()
    mengetik  ('\033[1;94m\xe2\x95\x91->\033[1;92mUser Id\033[1;91m:')
